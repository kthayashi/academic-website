Source code for my (new) academic website. Built using the [Academic template](https://github.com/wowchemy/starter-hugo-academic) for [Hugo](https://gohugo.io/) by [Wowchemy](https://wowchemy.com/). Work in progress.
...
- ⬆️ **Updating Wowchemy?** View the [Update Guide](https://wowchemy.com/docs/hugo-tutorials/update/) and [Release Notes](https://wowchemy.com/updates/)
